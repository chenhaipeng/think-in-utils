...
public class XmlMapperTest {
	...
	public void objectToXml() {
		...
		String xml = com.thinkme.utils.mapper.XmlMapper.toXml(user, "UTF-8");
	...
	public void xmlToObject() {
		...
		User user = com.thinkme.utils.mapper.XmlMapper.fromXml(xml, User.class);
	...
	public void toXmlWithListAsRoot() {
		...
		String xml = com.thinkme.utils.mapper.XmlMapper.toXml(userList, "userList", User.class, "UTF-8");
