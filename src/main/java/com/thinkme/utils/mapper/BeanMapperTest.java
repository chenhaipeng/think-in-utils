...
public class BeanMapperTest {
	...
	public void copySingleObject() {
		...
		StudentVO studentVo = com.thinkme.utils.mapper.BeanMapper.map(student, StudentVO.class);
		...
		//////////
		Type<Student> studentType = com.thinkme.utils.mapper.BeanMapper.getType(Student.class);
		Type<StudentVO> studentVoType = com.thinkme.utils.mapper.BeanMapper.getType(StudentVO.class);
		studentVo = com.thinkme.utils.mapper.BeanMapper.map(student, studentType, studentVoType);
	...
	public void copyListObject() {
		...
		List<StudentVO> studentVoList = com.thinkme.utils.mapper.BeanMapper.mapList(studentList, Student.class, StudentVO.class);
		...
		Type<Student> studentType = com.thinkme.utils.mapper.BeanMapper.getType(Student.class);
		Type<StudentVO> studentVoType = com.thinkme.utils.mapper.BeanMapper.getType(StudentVO.class);
		studentVoList = com.thinkme.utils.mapper.BeanMapper.mapList(studentList, studentType, studentVoType);

		studentVoList = com.thinkme.utils.mapper.BeanMapper.mapList(studentList, Student.class, StudentVO.class);
		assertThat(studentVoList).hasSize(3);
	...
	public void copyArrayObject() {
		...
		com.thinkme.utils.mapper.BeanMapper.mapArray(studentVoList, studentList, StudentVO.class);
		assertThat(studentVoList).hasSize(3);
		...
		com.thinkme.utils.mapper.BeanMapper.mapArray(studentVoList2, studentList,studentType, studentVoType);
		assertThat(studentVoList).hasSize(3);
