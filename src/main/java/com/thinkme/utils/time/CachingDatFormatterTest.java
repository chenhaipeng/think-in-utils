package com.thinkme.utils.time;
...
public class CachingDatFormatterTest {
	...
	public void test() {
		...
		CachingDateFormatter formatter = new CachingDateFormatter(com.thinkme.utils.time.DateFormatUtil.PATTERN_DEFAULT);
		...
		CachingDateFormatter formatterOnSecond = new CachingDateFormatter(com.thinkme.utils.time.DateFormatUtil.PATTERN_DEFAULT_ON_SECOND);
