...
public class FileUtilTest {
	...
	public void opFiles() throws IOException {
		File file = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testFile" + RandomUtil.nextInt()));
		FileUtil.touch(file);
		...
		File newFile = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testFile" + RandomUtil.nextInt()));
		File newFile2 = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testFile" + RandomUtil.nextInt()));
	...
	public void opDir() throws IOException {
		...
		File dir = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testDir"));

		File file = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testDir", fileName));
		String content = "haha\nhehe";
		FileUtil.makesureDirExists(dir);
		FileUtil.write(content, file);

		File dir2 = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testDir2"));
		FileUtil.copyDir(dir, dir2);
		File file2 = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testDir2", fileName));
		assertThat(FileUtil.toString(file2)).isEqualTo("haha\nhehe");

		File dir3 = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testDir3"));
		FileUtil.moveDir(dir, dir3);
		File file3 = new File(FilePathUtil.contact(com.thinkme.utils.base.Platforms.TMP_DIR, "testDir3", fileName));
	...
	public void fileExist() throws IOException {
		assertThat(FileUtil.isDirExists(com.thinkme.utils.base.Platforms.TMP_DIR)).isTrue();
		assertThat(FileUtil.isDirExists(com.thinkme.utils.base.Platforms.TMP_DIR + RandomUtil.nextInt())).isFalse();
