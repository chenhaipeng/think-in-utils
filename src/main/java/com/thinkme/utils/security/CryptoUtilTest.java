 ...
 *******************************************************************************/
package com.thinkme.utils.security;
...
public class CryptoUtilTest {
	...
	public void mac() {
		...
		System.out.println("hmac-sha1 key in hex      :" + com.thinkme.utils.text.EncodeUtil.encodeHex(key));
		System.out.println("hmac-sha1 in hex result   :" + com.thinkme.utils.text.EncodeUtil.encodeHex(macResult));
	...
	public void aes() {
		...
		System.out.println("aes key in hex            :" + com.thinkme.utils.text.EncodeUtil.encodeHex(key));
		System.out.println("aes encrypt in hex result :" + com.thinkme.utils.text.EncodeUtil.encodeHex(encryptResult));
	...
	public void aesWithIV() {
		...
		System.out.println("aes key in hex            :" + com.thinkme.utils.text.EncodeUtil.encodeHex(key));
		System.out.println("iv in hex                 :" + com.thinkme.utils.text.EncodeUtil.encodeHex(iv));
		System.out.println("aes encrypt in hex result :" + com.thinkme.utils.text.EncodeUtil.encodeHex(encryptResult));
		assertThat(descryptResult).isEqualTo(input);
	}
}
