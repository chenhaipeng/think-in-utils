...
import com.thinkme.utils.io.ResourceUtil;
...
public class HashUtilTest {
	...
	public void murmurhash() {
		...
		assertThat(HashUtil.murmur128AsLong("hahhha6".getBytes(com.thinkme.utils.text.Charsets.UTF_8))).isEqualTo(-5203515929515563680L);
