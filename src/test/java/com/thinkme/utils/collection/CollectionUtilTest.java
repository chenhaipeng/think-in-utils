...
public class CollectionUtilTest {
	...
	public void test() {
		...
		assertThat(java.util.Optional.ofNullable(CollectionUtil.getFirst(null))).isNull();
		assertThat(CollectionUtil.getLast(list1)).isNull();
		assertThat(java.util.Optional.ofNullable(CollectionUtil.getLast(null))).isNull();
	}
